...
export function StickyUploadManager() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 w-80 overflow-hidden rounded-lg border border-app-border bg-app-s1 shadow-xl">
      <button
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 text-xs text-app-t4">
            {completedCount > 0 && (
      ...
      {!isMinimized && (
        <>
          <div className="max-h-80 divide-y divide-app-border overflow-y-auto">
          ...
          {hasFinished && (
            <button
              ...
              className="w-full border-t border-app-border px-4 py-2 text-center text-xs font-medium text-app-t3 hover:bg-app-s2 hover:text-app-text"
            >
              Clear completed
            </button>
          )}
